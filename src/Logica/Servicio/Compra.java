...
public class Compra implements Serializable {
    ...
    public Compra(String numeroFactura, Date fecha, List<Productos_Compra> articulosRelacionados, int cantidadArticulos, double montoCompra, Proveedor unProveedor) throws Exception {
        this.id = 0;
    ...
    public Compra agregarUnPago (Pago unPago) {
         this.unPago=unPago;
         return this;
    }
